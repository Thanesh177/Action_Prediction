...
class ActionPredictionModel(tf.keras.Model):
    ...
    def call(self, inputs, training=False):
        ...
        # Normalize and pass through feature layers
        ...
        # BatchNorm returns float32, so ensure Y_past is float32 to match
